...
class OneVsAllClassifier:
    ...
    def fmargin_treewise(self, X, y, eps, fx_vals=None):
        ...
        if self.n_clsf > 1:
            ...
            diff = (
                cert_correct_class + fx_vals
            )  # plus because of [min -f] in cert for all classes
    ...
    def load(self, model_path, iteration=-1):
        ...
        print(
            "Ensemble of {}/{} trees restored: {}".format(
                true_iteration, n_trees, model_path
            )
        )
